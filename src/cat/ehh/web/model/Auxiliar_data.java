...
public class Auxiliar_data implements Serializable {
	...
	@Id
	@SequenceGenerator(name="AUXILIAR-DATA_IDAUXILIARDATA_GENERATOR", sequenceName="SEQ_AUXILIAR",initialValue=1,allocationSize=1)
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="AUXILIAR-DATA_IDAUXILIARDATA_GENERATOR")
