...
@XmlRootElement(name = "deletePatientFromResponsible", namespace = "http://ws.ehh.cat/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "deletePatientFromResponsible", namespace = "http://ws.ehh.cat/", propOrder = {"arg0", "arg1"})

public class DeletePatientFromResponsible {
