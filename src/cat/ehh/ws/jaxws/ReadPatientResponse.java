...
@XmlRootElement(name = "readPatientResponse", namespace = "http://ws.ehh.cat/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "readPatientResponse", namespace = "http://ws.ehh.cat/")

public class ReadPatientResponse {
