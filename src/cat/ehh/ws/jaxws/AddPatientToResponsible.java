...
@XmlRootElement(name = "addPatientToResponsible", namespace = "http://ws.ehh.cat/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "addPatientToResponsible", namespace = "http://ws.ehh.cat/", propOrder = {"arg0", "arg1"})
