...
@XmlRootElement(name = "getPatientGeofences", namespace = "http://ws.ehh.cat/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getPatientGeofences", namespace = "http://ws.ehh.cat/")

public class GetPatientGeofences {
