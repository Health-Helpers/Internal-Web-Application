...
@XmlRootElement(name = "getPatientResponsibles", namespace = "http://ws.ehh.cat/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getPatientResponsibles", namespace = "http://ws.ehh.cat/")

public class GetPatientResponsibles {
