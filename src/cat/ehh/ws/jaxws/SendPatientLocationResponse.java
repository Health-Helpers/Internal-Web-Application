...
@XmlRootElement(name = "sendPatientLocationResponse", namespace = "http://ws.ehh.cat/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "sendPatientLocationResponse", namespace = "http://ws.ehh.cat/")

public class SendPatientLocationResponse {
