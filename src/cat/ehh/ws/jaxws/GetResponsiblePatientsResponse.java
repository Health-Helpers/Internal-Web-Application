...
@XmlRootElement(name = "getResponsiblePatientsResponse", namespace = "http://ws.ehh.cat/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getResponsiblePatientsResponse", namespace = "http://ws.ehh.cat/")

public class GetResponsiblePatientsResponse {
