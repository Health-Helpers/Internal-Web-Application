...
@XmlRootElement(name = "deleteResponsibleFromPatient", namespace = "http://ws.ehh.cat/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "deleteResponsibleFromPatient", namespace = "http://ws.ehh.cat/", propOrder = {"arg0", "arg1"})

public class DeleteResponsibleFromPatient {
