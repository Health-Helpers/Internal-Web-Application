...
@XmlRootElement(name = "addPatientToResponsibleResponse", namespace = "http://ws.ehh.cat/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "addPatientToResponsibleResponse", namespace = "http://ws.ehh.cat/")

public class AddPatientToResponsibleResponse {
