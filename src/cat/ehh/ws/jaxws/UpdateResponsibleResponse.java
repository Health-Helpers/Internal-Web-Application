...
@XmlRootElement(name = "updateResponsibleResponse", namespace = "http://ws.ehh.cat/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "updateResponsibleResponse", namespace = "http://ws.ehh.cat/")

public class UpdateResponsibleResponse {
